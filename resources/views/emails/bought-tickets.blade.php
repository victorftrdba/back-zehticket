    ...
    <div style="text-align:center">
        ...
        @foreach ($codes as $code)
            <div style="margin-bottom:15px;">
                ...
                <div><b style="color:black;">INGRESSO PARA {{ $client_name  }}</b></div>
                <div style="margin-bottom:5px;"><b style="color:black;">{{ $code->ticket->description }}
                        | {{ $code->code }}</b></div>
                ...
                <div><b style="color:black;">{{ Carbon::parse($code->event->date)->format('d/m/y') }}</b></div>
            </div>
        @endforeach
    </div>
</div>
